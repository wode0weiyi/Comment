...
//  Clue_Global
//
//  Created by maomao on 2017/12/18.
...
@IBDesignable open class TQTextView: UITextView {
    ...
    private func commonInitializer() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(TQTextView.handleTextViewTextDidChangeNotification(_:)), name: NSNotification.Name.UITextViewTextDidChange, object: self)
    }
    
    @objc internal func handleTextViewTextDidChangeNotification(_ notification: Notification) {
        
        guard let object = notification.object as? TQTextView, object === self else {
