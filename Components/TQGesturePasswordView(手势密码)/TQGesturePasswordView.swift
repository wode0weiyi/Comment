...
class TQGestureButton: UIButton {
    ...
    func setUpView(){
        ...
        self.backgroundColor = UIColor(hex: "#d5dbe8")
    }
...
class TQGesturePasswordView: UIView {
    ...
    var gesturePassWordType : TQGesturePasswordType?{
        ...
        set(newValue){
            ...
            self.strokePwdView.updateView();
            self.loginHeaderView.updateView(msg: "请输入手势密码", color: UIColor(hex: "333333"))
            self.setPwdHeaderView.updateView(passWord: "", message: "设置手势密码")
...
extension TQGesturePasswordView{
    ...
    func setup(){
        ...
        self.cancelSetBtn.setTitleColor(UIColor(hex:"#999999"), for: UIControlState.normal)
        ...
        self.forgetPwdBtn.setTitleColor(UIColor(hex:"#999999"), for: UIControlState.normal)
        ...
        self.changeLoginBtn.setTitleColor(UIColor(hex:"#999999"), for: UIControlState.normal)
        ...
        self.skipSetBtn.setTitleColor(UIColor(hex:"#999999"), for: UIControlState.normal)
        ...
        let height = ButtonSpace * 2 + ButtonWidth * 3
        let bottom = (isIphoneX ? (kSCREEN_HEIGHT - 34.0 - 30.0 - height - 200.0) : (kSCREEN_HEIGHT - height - 200.0))
        
        self.strokePwdView.snp.makeConstraints { (make) in
            make.left.right.equalTo(0)
            make.height.equalTo(height)
            make.bottom.equalTo(-CGFloat(bottom / 2))
        }
        //设置密码头部视图
...
//                }
    ...
    @objc func skipSetBtnClick(sender:UIButton){
        self.dismiss()
        if self.gesturePasswordClickBtnCallBack != nil {
            self.gesturePasswordClickBtnCallBack!(TQGesturePasswordBtnType.skipSet)
        }
    }
}
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for button in self.subviews{
            ...
            if button.isKind(of: TQGestureButton.self) {
                ...
                button.backgroundColor  =  UIColor(hex: "#d5dbe8")
...
//                设置按钮的背景色为lan色
   ...
   fileprivate func strokePassWordComplete(){
        ...
        case TQGesturePasswordType.login.rawValue: do {
            ...
            let oldPwd = UserInfoViewModel.shared.getUserInfoWithNearlyUser().2
            if oldPwd == str {
                //描绘的密码和保存的一致，成功
...
extension TQGesturePasswordLoginView{
    func setUpView(){
        ...
        self.deslab.textColor = UIColor(hex: "#333333")
        ...
        versionLab.snp.makeConstraints { (make) in
            ...
            make.top.equalTo(img.snp.centerY).offset(10)
...
extension TQGesturePasswordSetView{
    func setUp() {
        ...
        titleLab.textColor = UIColor(hex: "#333333")
...
class SmallBoxView: UIView {
    ...
    func setUp(){
        ...
        for i in 0..<9 {
            ...
            lab.backgroundColor = UIColor(hex: "#d5dbe8")
            self.addSubview(lab)
        }
